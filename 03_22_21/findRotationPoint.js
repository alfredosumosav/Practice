...
note: To keep things simple, you can assume all words are lowercase.
*/


// Time and space complexity analysis
// O(l*log(n)) time and O(1) space, where n is the length of the input array of 
// words and l is the length of the longest word in the dictionary
